        ...
        <div className="br2 ma1 ml0 pb2">
          <div className="fr w-100 w-50-ns pl3-ns pb4">
            <div className="relative w-100">
              ...
              <a className="darken dim"
                href="https://www.newfrontinsurance.com"
                onclick="trackOutboundLink('https://www.newfrontinsurance.com'); return false;">
                <img className="w-100 br2" src="./assets/newfront-insurance-thumbnail.png" />
              </a>
            </div>
          </div>
          <p className="white pb2 lh-copy">
            After designing public health tools at <a className="white hover-pink" href="https://iodine.com" target="_blank">Iodine</a>,
          ...
          <p className="white pb2 lh-copy">
            If you're looking for commercial or personal insurance or are interested in helping build a big business, join us at <a className="white hover-blue" href="https://www.newfrontinsurance.com" target="_blank">Newfront</a>.
          </p>
      ...
      <div className="fl w-100-m w-25-ns">
        ...
        <div className="fl w-100 w-50-m pa1">
          <div className="relative w-100">
            ...
            <a className="darken dim" href="https://github.com/michaelwschultz/timelapse-app">
