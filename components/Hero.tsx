...
const Hero = ({ heroFontStyles }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-md bg-[#6D962A] p-10">
      <h1
        className={`${heroFontStyles} text-4xl font-bold uppercase tracking-tighter text-[#DBE8A8] opacity-0
         lg:text-[114px] lg:leading-[114px] xl:text-[168px] xl:leading-[168px] ${
      ...
      <Image
        ...
        width={305}
        height={606}
        className={`absolute left-60 top-24 h-[606px] w-[305px] drop-shadow-2xl ${
      ...
      <p
        className={`pt-24 text-[#042C0E] xl:whitespace-pre ${
